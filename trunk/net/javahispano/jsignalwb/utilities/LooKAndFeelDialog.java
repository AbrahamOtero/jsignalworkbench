...
;
   ...
   * muestren si se lanza alguna excepción al cambiar el Look and Feel
   * @param parent JFrame al que le queréis cambiar el Look an Feel.
   * @param look_and_feel_no_soportado Mensaje se debe mostrar cuando el usuario selecione un Look and Feel no soportado.
   * @param otro_error Mensaje a mostrar cuando se produce una excepción cualquiera salvo aquella producida por un Look and Feel no soportado.
   */
  public LooKAndFeelDialog(JFrame parent, String look_and_feel_no_soportado, String otro_error) {
    ...
    //estas líneas son necesarias para actualizar el texto de error
   ...
   * si se lanza alguna excepción al cambiar el Look and Feel
   * @param parent JFrame al que le queréis cambiar el Look an Feel.
   */
  ...
  private void jbInit(JFrame parent) {
    ...
    jLabel3.setText("Aquí tiene algunas muestras de la apariencia que tendrá la aplicación:");
    jLabel2.setFont(new java.awt.Font("Dialog", 0, 15));
    jLabel2.setForeground(Color.blue);
    jLabel2.setText("Elija el Look And Feel que prefiere para la plicación:");
  ...
  /**
   * Devuelve el texto a mostrar cuando se produce una excepción cualquiera
   * salvo aquella producida por un Look and Feel no soportado.
   * @return Texto a mostrar cuando se produce una excepción cualquiera.
   */
