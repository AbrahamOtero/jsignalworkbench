package net.javahispano.jsignalwb.plugins.basicstats;
...
import java.io.*;
import net.javahispano.jsignalwb.plugins.basicstats.UI.NewStatisticsDialog;
...
public class BasicStatisticsPlugin extends AlgorithmAdapter implements Plugin {
     ...
     */
    public Icon getIcon() {
        return new ImageIcon(net.javahispano.jsignalwb.plugins.basicstats.
