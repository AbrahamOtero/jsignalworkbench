        ...
        if(true){
            ...
            synchronized(syncElements){
                ...
                for(Channel c:channels.values()){
                    ...
                    if(c.getChannelProperties().getEndTime()<jsmProperties.getTimeAtLocation(getSize().width-hLeftOffsetScale-10)){
                        endOffset=(getSize().width-hLeftOffsetScale-10)- (jsmProperties.getLocationAtTime(c.getChannelProperties().getEndTime()));
                    }
